...
"use strict";function _classCallCheck(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,n){for(var t=0;t<n.length;t++){var o=n[t];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(n,t,o){return t&&e(n.prototype,t),o&&e(n,o),n}}(),template=require("./template"),AutoComplete=require("./auto-complete.js"),TocJumper=function(){function e(n){_classCallCheck(this,e),this.data=null,this.opt={id:"toc_jumper",selector:"",transform:null,key:"i",top:"4em",right:".5em",bottom:"auto",left:"auto"};for(var t in n)n.hasOwnProperty(t)&&(this.opt[t]=n[t]);this.log=console.log.bind(console,"TocJumper:"),this.log("init")}return _createClass(e,[{key:"scroll",value:function(e){e in this.data&&(this.log(e),this.data[e].scrollIntoView(!0))}},{key:"hook",value:function(){var e=this;this.data=make_index(this.opt.selector,this.opt.transform),css_inject({id:this.opt.id}),document.body.addEventListener("keydown",function(n){"INPUT"!==n.target.nodeName&&(n.key!==e.opt.key||n.ctrlKey||e.dlg())})}},{key:"dlg",value:function(){var n=this,t=document.getElementById(this.opt.id);if(t)return focus(t);t=document.createElement("div"),t.id=this.opt.id,["top","right","bottom","left"].forEach(function(e){return t.style[e]=n.opt[e]});var o=this.opt.id+"_container";t.innerHTML='<span id="'+o+'"><input size="40" spellcheck="false" /></span>\n<span id="'+this.opt.id+'_close" title="Close"><span>&times;</span></span>',document.body.appendChild(t);var i=t.querySelector("input"),r=new AutoComplete({selector:i,minChars:1,delay:50,container:"#"+o,source:function(t,o){var i=[];for(var r in n.data)r.toLowerCase().indexOf(t.toLowerCase())!==-1&&i.push(r);o(e.sort(i,t))},onSelect:function(e,t,o){return n.scroll(t)}}),l=function(){r.destroy(),document.body.removeChild(t)};t.querySelector("#"+this.opt.id+"_close").onclick=l,t.addEventListener("keydown",function(e){"Enter"===e.key&&n.scroll(i.value),e.key.match(/^Esc/)&&l()}),focus(t)}}],[{key:"sort",value:function(e,n){return e.sort(function(e,t){return e.slice(0,n.length)===n?-1:t.slice(0,n.length)===n?1:e.localeCompare(t)})}}]),e}();module.exports=TocJumper;var make_index=function(e,n){for(var t=document.querySelectorAll(e),o={},i={},r=0;r<t.length;++r){var l=t[r],a=n?n(l.innerText):l.innerText;i[a]=(i[a]||0)+1,a in o&&(a=a+" <"+i[a]+">"),o[a]=l}return o},css_inject=function(e){var n=document.createElement("style"),t=template("/* auto-complete.js */\n.autocomplete-suggestions {\n  text-align: left;\n  cursor: default;\n  border: 1px solid #ccc;\n  border-top: 0;\n  background: white;\n  box-shadow: -1px 1px 3px rgba(0, 0, 0, .1);\n\n  position: absolute;\n  display: none;\n  z-index: 9999;\n  max-height: 15em;\n  overflow: hidden;\n  overflow-y: auto;\n  box-sizing: border-box;\n}\n.autocomplete-suggestion {\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.autocomplete-suggestion.selected {\n  background: #eee;\n}\n\n/* toc-jumper */\n#<%= id %> {\n  border: 1px solid #a9a9a9;\n  padding: 0.8em;\n  background-color: white;\n  color: black;\n  box-shadow: 1px 1px 3px rgba(0, 0, 0, .4);\n  position: fixed;\n  top: 4em;\n  right: .5em;\n}\n\n#<%= id %>_close {\n  margin-left: 1em;\n  font-weight: bold;\n  cursor: pointer;\n  text-align: center;\n  line-height: 2em;\n  width: 2em;\n  height: 2em;\n  display: inline-block;\n}\n\n#<%= id %>_close > span {\n  display: inline-block;\n}\n\n#<%= id %>_close:hover {\n  background-color: #e81123;\n  color: white;\n}\n");n.innerHTML=t(e),document.body.appendChild(n)},focus=function(e){setTimeout(function(){return e.querySelector("input").focus()},1)};
