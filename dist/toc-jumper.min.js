...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,t){for(var o=0;o<t.length;o++){var n=t[o];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,o,n){return o&&e(t.prototype,o),n&&e(t,n),t}}(),template=require("./template"),AutoComplete=require("./auto-complete.js"),Movable=function(){function e(t){_classCallCheck(this,e),this.node=t,this.offset_x=null,this.offset_y=null,this.mousedown=this._mousedown.bind(this),this.mousemove=this._mousemove.bind(this),this.mouseup=this._mouseup.bind(this),this.log=console.log.bind(console,"Movable:")}return _createClass(e,[{key:"position",value:function(e){var t=e.clientX-this.offset_x,o=e.clientY-this.offset_y;return t<0&&(t=0),o<0&&(o=0),{x:t,y:o}}},{key:"move",value:function(e,t){this.node.style.left=e+"px",this.node.style.top=t+"px",this.node.style.right="auto",this.node.style.bottom="auto"}},{key:"_mousedown",value:function(e){this.node===e.target&&(this.offset_x=e.clientX-this.node.offsetLeft,this.offset_y=e.clientY-this.node.offsetTop,this.log("mousedown, offset_x="+this.offset_x+", offset_y="+this.offset_y),document.addEventListener("mousemove",this.mousemove),this._mousemove(e))}},{key:"_mousemove",value:function(e){this.node.style.cursor="move";var t=this.position(e);this.move(t.x,t.y)}},{key:"_mouseup",value:function(e,t){(t||this.node===e.target)&&(this.log("mouseup"),document.removeEventListener("mousemove",this.mousemove),this.node.style.cursor="default")}},{key:"hook",value:function(){this.node.addEventListener("mousedown",this.mousedown),this.node.addEventListener("mouseup",this.mouseup)}},{key:"unhook",value:function(){this.node.removeEventListener("mousedown",this.mousedown),this.node.removeEventListener("mouseup",this.mouseup),document.removeEventListener("mousemove",this.mousemove)}}]),e}(),TocJumper=function(){function e(t){_classCallCheck(this,e),this.data=null,this.opt={id:"toc_jumper",selector:"",transform:null,key:"i",top:"4em",right:".5em",bottom:"auto",left:"auto"};for(var o in t)t.hasOwnProperty(o)&&(this.opt[o]=t[o]);this.log=console.log.bind(console,"TocJumper:"),this.log("init")}return _createClass(e,[{key:"scroll",value:function(e){e in this.data&&(this.log(e),this.data[e].scrollIntoView(!0))}},{key:"hook",value:function(){var e=this;this.data=make_index(this.opt.selector,this.opt.transform),css_inject({id:this.opt.id}),document.body.addEventListener("keydown",function(t){"INPUT"!==t.target.nodeName&&(t.key!==e.opt.key||t.ctrlKey||e.dlg(),t.key.match(/^Esc/)&&e.movable._mouseup(null,!0))})}},{key:"dlg",value:function(){var t=this,o=document.getElementById(this.opt.id);if(o)return focus(o);o=document.createElement("div"),o.id=this.opt.id,["top","right","bottom","left"].forEach(function(e){return o.style[e]=t.opt[e]});var n=this.opt.id+"_container";o.innerHTML='<span id="'+n+'"><input size="40" spellcheck="false" /></span>\n<span id="'+this.opt.id+'_close" title="Close"><span>&times;</span></span>',document.body.appendChild(o);var s=o.querySelector("input"),i=new AutoComplete({selector:s,minChars:1,delay:50,container:"#"+n,source:function(o,n){var s=[];for(var i in t.data)i.toLowerCase().indexOf(o.toLowerCase())!==-1&&s.push(i);n(e.sort(s,o))},onSelect:function(e,o,n){return t.scroll(o)}}),r=function(){i.destroy(),t.movable.unhook(),document.body.removeChild(o)};o.querySelector("#"+this.opt.id+"_close").onclick=r,o.addEventListener("keydown",function(e){"Enter"===e.key&&t.scroll(s.value),e.key.match(/^Esc/)&&r()}),this.movable=new Movable(o),this.movable.hook(),focus(o)}}],[{key:"sort",value:function(e,t){return e.sort(function(e,o){return e.slice(0,t.length)===t?-1:o.slice(0,t.length)===t?1:e.localeCompare(o)})}}]),e}();module.exports=TocJumper;var make_index=function(e,t){for(var o=document.querySelectorAll(e),n={},s={},i=0;i<o.length;++i){var r=o[i],u=t?t(r.innerText):r.innerText;s[u]=(s[u]||0)+1,u in n&&(u=u+" <"+s[u]+">"),n[u]=r}return n},css_inject=function(e){var t=document.createElement("style"),o=template("/* auto-complete.js */\n.autocomplete-suggestions {\n  text-align: left;\n  cursor: default;\n  border: 1px solid #ccc;\n  border-top: 0;\n  background: white;\n  box-shadow: -1px 1px 3px rgba(0, 0, 0, .1);\n\n  position: absolute;\n  display: none;\n  z-index: 9999;\n  max-height: 15em;\n  overflow: hidden;\n  overflow-y: auto;\n  box-sizing: border-box;\n}\n.autocomplete-suggestion {\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.autocomplete-suggestion.selected {\n  background: #eee;\n}\n\n/* toc-jumper */\n#<%= id %> {\n  border: 1px solid #a9a9a9;\n  padding: 0.8em;\n  background-color: white;\n  color: black;\n  box-shadow: 1px 1px 3px rgba(0, 0, 0, .4);\n\n  position: fixed;\n}\n\n#<%= id %>_close {\n  margin-left: 1em;\n  font-weight: bold;\n  cursor: pointer;\n  text-align: center;\n  line-height: 2em;\n  width: 2em;\n  height: 2em;\n  display: inline-block;\n}\n\n#<%= id %>_close:hover {\n  background-color: #e81123;\n  color: white;\n}\n");t.innerHTML=o(e),document.body.appendChild(t)},focus=function(e){setTimeout(function(){return e.querySelector("input").focus()},1)};
